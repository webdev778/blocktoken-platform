                ...
                <footer className="footer">
                    <div className="footer__partitions">
                        <div className="footer__partition footer__partition--logoTitle">
                            <a href="https://blocktoken.ai/" className="footer__logoLink">
                                <img
                        ...
                        <div className="footer__partition">
                            ...
                            <ul className="footer__navList">
                                <li className="footer__navItem">
                                    <a href="https://blocktoken.ai/products" className="footer__navLink">
                                        Products Overview
                                    </a>
                                </li>
                                <li className="footer__navItem">
                                    <a href="https://blocktoken.ai/features" className="footer__navLink">
                                        Key Features
                                    </a>
                                </li>
                                <li className="footer__navItem">
                                ...
                                <li className="footer__navItem">
                                    <a href="https://blocktoken.ai/token-generator"
                                        className="footer__navLink">
                                        Create a Token
                                    </a>
                                </li>
                                <li className="footer__navItem">
                                    <a href="https://blocktoken.ai/ico-advisory"
                                        className="footer__navLink">
                                        ICO Advisory
                                    </a>
                                </li>
                                <li className="footer__navItem">
                                    <a href="https://blocktoken.ai/syndicates" className="footer__navLink">
                        ...
                        <div className="footer__partition">
                            ...
                            <ul className="footer__navList">
                                <li className="footer__navItem">
                                    <a href="https://blocktoken.ai/token" className="footer__navLink">
                                        Token Sale
                                    </a>
                                </li>
                                <li className="footer__navItem">
                                    <a href="https://blocktoken.ai/terms" className="footer__navLink">
                                        Terms &amp; Conditions
                                    </a>
                                </li>
                                <li className="footer__navItem">
                                    <a href="https://blocktoken.ai/cookies-policy" className="footer__navLink">
                                        Cookie Policy
                                    </a>
                                </li>
                                <li className="footer__navItem">
                                    <a href="https://blocktoken.ai/risk-warnings" className="footer__navLink">
                                        Risk Warnings
                                    </a>
                                </li>
                                <li className="footer__navItem">
                                    <a href="https://blocktoken.ai/privacy" className="footer__navLink">
                                        Privacy Policy
                                    </a>
                                </li>
                            </ul>
