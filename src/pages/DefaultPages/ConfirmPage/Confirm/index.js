...
class Confirm extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="main-confirm main-confirm--fullscreen">
        <div className="main-confirm__header">
          <div className="row">
            <div className="col-lg-12">
              <div className="main-confirm__header__logo">
        ...
        <div className="main-confirm__block pb-0">
          <div className="row">
            <div className="col-xl-12">
              <div className="main-confirm__block__promo text-black text-center">
              ...
              <div className="main-confirm__block__inner">
                <div className="main-confirm__block__form">
                  <ConfirmForm />
                </div>
                <div className="main-confirm__block__sidebar">
                  <h4 className="main-confirm__block__sidebar__title text-white">
                    <strong>BlockToken Token Offering Pre Sale Begins</strong>
                    <br />
                    <span>August 2018</span>
                  </h4>
                  <div className="main-confirm__block__sidebar__item">
                    BlockToken is a platform for the Distribution & Marketing of ICOs and Tokens.
                  </div>
                  <div className="main-confirm__block__sidebar__place">
        ...
        <div className="main-confirm__footer text-center">
