      ...
      <div>
        ...
        <div className="row-lg-6">
          <FormItem>
            ...
            <Input type="text" placeholder="e.g. 240" required />
            <label className="form-label">
        ...
        <div className="row-lg-6">
          <FormItem>
            ...
            <Input type="text" placeholder="e.g. 480" required />
            <label className="form-label">
        ...
        <div className="row-lg-6">
          <FormItem>
            ...
            <Input type="text" placeholder="e.g. 5" required />
            <label className="form-label">
              The bonus is a percentage of the amount of purchased tokens. E.g. if user buys 100
              tokens and bonus is 50%, user gets 150 tokens.
            </label>
        ...
        <div className="row-lg-6">
          <FormItem>
            ...
            <Input type="text" placeholder="e.g. 50" required />
            <label className="form-label">
